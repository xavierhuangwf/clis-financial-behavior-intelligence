...
# read CSV file
file_path = 'C:\\Users\\levit\\Downloads\simulated_fake_transactions_dataset_2.csv'
...
# ### why not fill the null values in 'Date' and 'Timestamp' columns?
# Since the Date and Timestamp columns contain null values and are not in complete order, they are not easy to fill. There are only 547 rows of data in this part, accounting for about 0.002%, so they are deleted.
...
df_sorted.to_csv("C:\\Users\\levit\\Downloads\sorted_data.csv", index=False)
...
expenses_data.to_csv("C:\\Users\\levit\\Downloads\expenses_data.csv", index=False)
...
expenses_go_data.to_csv("C:\\Users\\levit\\Downloads\expenses_go_data.csv", index=False)
...
print(sorted_thirdparty_count.to_string())
...
expenses_go_data.to_csv("C:\\Users\\levit\\Downloads\expenses_go_data_with_categories.csv", index=False)
