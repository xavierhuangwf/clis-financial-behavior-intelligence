...
- `artifacts/` trained models and rule dictionaries
- `outputs/` generated predictions, recommendations, figures, metrics, and sample results
- `archive/` experimental, exploratory, or deprecated files retained for reference
...
- The repository is designed to separate source code, data placeholders, artifacts, outputs, and archived experiments to support reproducibility and clearer project presentation.
